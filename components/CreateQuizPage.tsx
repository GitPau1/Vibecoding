        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            />
             {imageUrl && (
              <div className="mt-2">
                <ImageWithFallback src={imageUrl} alt="Quiz preview" className="mx-auto h-32 w-auto object-cover rounded-md border" />
              </div>
            )}
          </div>
              ...
              {questions.map((q, qIndex) => (
                  <div key={qIndex} className="p-4 border rounded-xl bg-gray-50/50 space-y-4 relative group">
                      ...
                      <div className="pl-8 space-y-3">
                          ...
                          {q.imageUrl && (
                            <div className="mt-2">
                                <ImageWithFallback src={q.imageUrl} alt={`Question ${qIndex + 1} preview`} className="mx-auto h-24 w-auto object-cover rounded-md border"/>
                            </div>
                          )}
