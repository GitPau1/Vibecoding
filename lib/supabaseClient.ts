...
// The default recursive `Json` type generated by Supabase can cause a
// "Type instantiation is excessively deep and possibly infinite" error in TypeScript.
// By replacing the `Json` type alias with `any` directly in the table definitions
// for jsonb columns, we can work around this issue.
...
CREATE POLICY "Allow anon all on squad_players" ON squad_players FOR ALL USING (true) WITH CHECK (true);
